 ...
 */
public class AppdLineGraphicView extends View{
    ...
    public AppdLineGraphicView(Context context)
    {
        this(context, null);
    }

    public AppdLineGraphicView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
...
//            }
    ...
    private void drawAllXLine(Canvas canvas)
    {
        for (int i = 0; i < spacingHeight + 1; i++)
        {
            ...
            if(i == 1){
                text = getResources().getString(R.string.wei_1);
            }
            if(i == 2){
                text = getResources().getString(R.string.wei_2);
            }
            if(i == 3){
                text = getResources().getString(R.string.wei_3);
            }
            if(i == 4){
                text = getResources().getString(R.string.wei_4);
            }
            if(i == 5){
                text = getResources().getString(R.string.wei_5);
            }
