...
import com.sage.hedonicmentality.fragment.My.inner.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	private void initView(Context context)
	{
		...
		rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.reverse_animss);
		refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.rotatingss);
		// 添加匀速转动动画
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		case FAIL:
			...
			loadStateTextView.setText(R.string.not_list);
			loadStateImageView.setBackgroundResource(R.mipmap.load_succeed);
			break;
		default:
			// 加载失败
	...
	private void changeState(int to)
	{
		...
		case INIT:
			...
			refreshStateTextView.setText(R.string.pull_to_refreshss);
			pullView.clearAnimation();
		...
		case RELEASE_TO_REFRESH:
			// 释放刷新状态
			refreshStateTextView.setText(R.string.release_to_refreshss);
		...
		case REFRESHING:
			...
			refreshStateTextView.setText(R.string.refreshingss);
			break;
