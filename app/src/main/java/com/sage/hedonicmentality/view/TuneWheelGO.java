...
public class TuneWheelGO extends View {
    ...
    private static final int ITEM_ONE_DIVIDER = 46;
    ...
    private int mMaxValue = 9, mModType = 1, mLineDivider = ITEM_ONE_DIVIDER;
    public  int mValue = 5;
    ...
    public TuneWheelGO(Context context, AttributeSet attrs) {
        super(context, attrs);
                ...
                if ((mValue + i) % mModType == 0) {
                    if (mValue + i>mMaxValue||mValue + i<minValue) {
                        ...
                        if (mValue + i != mValue) {
                            ...
                            canvas.drawText(String.valueOf((mValue + i)), countLeftStart(mValue + i, xPosition, textWidth), getHeight() - textWidth, centerText);
                        }
                    }
            ...
            if (xPosition > getPaddingLeft()) {
                if ((mValue - i) % mModType == 0) {
                    if (mValue - i>mMaxValue||mValue - i<minValue) {
                        ...
                        if ((mValue - i) != mValue) {
                            canvas.drawText(String.valueOf((mValue - i)), countLeftStart(mValue - i, xPosition, textWidth), getHeight() - textWidth, textPaint);
                            LogUtils.e("wsmmeiyou:"+String.valueOf((mValue - i))+"mValue+"+mValue);
                        } else {
                            canvas.drawText(String.valueOf((mValue - i)), countLeftStart(mValue - i, xPosition, textWidth), getHeight() - textWidth, centerText);
                        }
                    }
    ...
    private void changeMoveAndValue() {
        int tValue = (int) (mMove / (mLineDivider * mDensity));
            if (Math.abs(tValue) > 0) {
                LogUtils.e("mValue+"+mValue+"tValue+"+tValue);
                mValue += tValue;
