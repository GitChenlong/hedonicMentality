...
package com.sage.libimagechoose.api;
...
import com.sage.libimagechoose.api.config.Config;
import com.sage.libimagechoose.threads.ImageProcessorListener;
import com.sage.libimagechoose.threads.ImageProcessorThread;
...
public class ImageChooserManager extends BChooser implements
	...
	public ImageChooserManager(Activity activity, int type) {
		super(activity, type, DIRECTORY, false);
	}

	public ImageChooserManager(Fragment fragment, int type) {
		super(fragment, type, DIRECTORY, false);
	}
