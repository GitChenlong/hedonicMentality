...
import com.sage.libwheelview.widget.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	public void setWheelForeground(int resource) {
		...
		backgrongDrawable = getContext().getResources().getDrawable(bg);
	}
...
//			drawCenterRect(canvas);
	...
	private void drawbgRect(Canvas canvas) {
		int center = getHeight() / 2;
		int offset = (int) (getItemHeight() / 2 * 1.2);
		backgrongDrawable.setBounds(-1, -1, getWidth()+1,getHeight()+1);
		backgrongDrawable.draw(canvas);
	}
